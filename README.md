...
3. **Import pin assignments** — in Quartus, go to *Assignments → Import Assignments* and load the provided `.qsf` file. This maps all ports to the correct DE1-SoC pins.

4. **Compile** the project (`Ctrl+L` or *Processing → Start Compilation*).

5. **Program the board** via *Tools → Programmer*, selecting the generated `.sof` file.
